...
const commonNavItems = [
  {
    ...
    icon: (
      <div
        className="text-[#111418] dark:text-gray-300"
        data-icon="House"
        data-size="24px"
        data-weight="fill"
      >
...
export default function Sidebar() {
  ...
  return (
    <div className="flex h-full min-h-[700px] flex-col justify-between bg-white dark:bg-gray-900 shadow-md overflow-y-auto">
      <div className="flex h-full min-h-[700px] flex-col justify-between bg-white dark:bg-gray-900 p-4 shadow-md">
            ...
            {filteredNavItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  ...
                  ${
                    isActive
                      ? "bg-[#f0f2f5] dark:bg-gray-800 text-[#111418] dark:text-white"
                      : "text-[#111418] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
                  }`
                }
              >
                <div className="text-[#111418] dark:text-gray-300">
                  {item.icon}
                </div>
                <p>{item.label}</p>
              </NavLink>
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-[#111418] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 mt-auto"
        >
          <div className="text-[#111418] dark:text-gray-300">
            <svg
              xmlns="http://www.w3.org/2000/svg"
